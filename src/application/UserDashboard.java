...
//        List<ManageProduct.Product> productList = databaseManager.getAllProducts();
//
//        // Create an ObservableList to store the product data
//        ObservableList<ManageProduct.Product> products = FXCollections.observableArrayList(productList);
//
//        // Create a new TableView to display the product list
//        TableView<ManageProduct.Product> tableView = createProductTable();
//
//        // Add products to the TableView
//        tableView.setItems(products);
//
//        // Create labels for detailed product information
//        Label productDetailLabel = new Label("Product Detail:");
//        Label productNameLabel = new Label("Product Name:");
//        Label productBrandLabel = new Label("Product Brand:");
//        Label productStockLabel = new Label("Product Stock:");
...
//
//        // Create a VBox to hold detailed product information
//        VBox productDetailLayout = new VBox(5); // 5 is spacing between components
//        productDetailLayout.getChildren().addAll(
//                productDetailLabel, productNameLabel, productBrandLabel,
//                productStockLabel, productPriceLabel, quantitySpinner, addToCartButton
//        );
//
//        // Create a new VBox layout for the Home page
//        VBox homeLayout = new VBox(10); // 10 is spacing between components
//        Label productListLabel = new Label("Product List");
//        homeLayout.getChildren().addAll(productListLabel, tableView, productDetailLayout);
//
//        // Create a new Scene with the VBox layout
//        Scene homeScene = new Scene(homeLayout, 800, 600);
//
...
//
//                if (selectedProduct != null) {
//                    // Update the detailed product information
//                    productNameLabel.setText("Product Name: " + selectedProduct.getName());
//                    productBrandLabel.setText("Product Brand: " + selectedProduct.getBrand());
//                    productStockLabel.setText("Product Stock: " + selectedProduct.getStock());
//                    productPriceLabel.setText("Product Price: " + selectedProduct.getPrice());
//
